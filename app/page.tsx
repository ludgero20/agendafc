...
// Tipos 100% alinhados com o JogoListClient (sem null em divisao e fase)
type JogoSemana = { 
  id: number; 
  data: string; 
  campeonato: string; 
...
async function carregarDadosDosJogos() {
  try {
    ...
    // Converte sessões da F1 com divisao e fase como undefined
    ...
    // Junta tudo e sanitiza para garantir que divisao e fase nunca sejam null
