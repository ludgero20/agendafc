...
export default function SemanaListClient({ 
  ...
  // --- FILTRO COMBINADO (CAMPEONATO + CANAL) ---
  useEffect(() => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="filtroCompeticaoSemana" className="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div>
          <label htmlFor="filtroCanalSemana" className="block text-sm font-medium text-gray-700 mb-1">
            📺 Filtrar por canal:
          </label>
          <select
      ...
      {Object.keys(jogosPorData).length === 0 ? (
        <div className="bg-white rounded-xl p-8 text-center border">
          ...
          <p className="text-gray-600">Não há jogos ou corridas programadas para os filtros selecionados.</p>
        </div>
      ) : (
                                ...
                                <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between gap-2">
                                  ...
                                  <div className="flex items-center gap-1.5 flex-shrink-0">
                                    ...
                                    <a
                                      ...
                                      className="inline-flex items-center gap-1 text-xs font-semibold bg-emerald-500 hover:bg-emerald-600 text-white px-2.5 py-1.5 rounded-md transition-colors shadow-sm"
                                    >
